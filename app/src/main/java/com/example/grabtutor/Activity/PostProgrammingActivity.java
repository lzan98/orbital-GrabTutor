...
public class PostProgrammingActivity extends AppCompatActivity {
    ...
    private void upload() {
        ...
        if (imageUri != null){
            final StorageReference filePath = FirebaseStorage.getInstance().getReference("Programming").child(System.currentTimeMillis() + "." + getFileExtension(imageUri));
            ...
            uploadtask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    ...
                    DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Programming");
